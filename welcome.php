...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']!=true){
    header("location: /project/loginsystem/login.php");
    exit;
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="alert alert-success" role="alert">
      ...
      <hr>
      <p class="mb-0">Whenever you need to, be sure to logout <a href="/project/loginsystem/logout.php"> using this link.</a></p>
    </div>
  </div>
    <!-- Optional JavaScript -->
